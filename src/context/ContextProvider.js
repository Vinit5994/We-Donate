...
const ContextProvider = props => {
    ...
    const notLogged = ['/', '/user/signup', '/user/login', '/ngo/signup', '/ngo/login', '/ngos', '/ngo/id/:uid' , '/partners']
    const userLogged = ['/user', '/user/profile', '/ngo/id/:uid', '/user/donate', '/user/donations', '/user/money', '/partners']
    const ngoLogged = ['/ngo', '/ngo/profile', '/ngo/id/:uid', '/ngos', '/ngo/dashboard', '/ngo/dashmore' , '/partners','/testimonials']
